...
public class frmSanPhamAn extends javax.swing.JFrame {
    ...
    private void tblSanPham_spaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPham_spaMouseClicked
        ...
        Nhom_25.Vanlinh.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 3).toString(), cbbMaLoaiSanPham_SanPhamAn);
        Nhom_25.Vanlinh.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 6).toString(), cbbHangSanXuat_SanPhamAn);
    ...
    private void jPanelSanPham_spaComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanelSanPham_spaComponentShown
       LayDuLieuSanPham("0");
        ...
        cbbMaLoaiSanPham_SanPhamAn.setModel(Nhom_25.Vanlinh.frmTC.LayDuLieucbb("LoaiSanPham", "TenLoaiSanPham", "MaLoaiSanPham"));
        cbbHangSanXuat_SanPhamAn.setModel(Nhom_25.Vanlinh.frmTC.LayDuLieucbb("HangSanXuat", "TenHangSanXuat", "MaHangSanXuat"));
    ...
    private void btnHienlai_SanPhamAnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHienlai_SanPhamAnActionPerformed
        ...
        if (kiemtra) {
            Vanlinh.connection.ExcuteQueryUpdateDB(cautruyvan);
            System.out.println("Đã Sửa Thành Công Sản Phẩm");
        } else {
            Nhom_25.Vanlinh.frmTC.ThongBao("Không thể ", "Sửa Sản Phẩm", 2);
        }
      LayDuLieuSanPham("0");
      ResSanPham();
      Nhom_25.Vanlinh.frmTC.LayDuLieuSanPham("1");
  ...
  public void ResSanPham(){
    ...
    public void LayDuLieuSanPham(String TrangThai) {
        ...
        ResultSet rs = Vanlinh.connection.ExcuteQueryGetTable(cautruyvan);
